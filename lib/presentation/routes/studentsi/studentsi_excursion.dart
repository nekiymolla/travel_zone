...
class StudentsiExcursion extends StatefulWidget {
  const StudentsiExcursion({super.key});

  @override
  State<StudentsiExcursion> createState() => _StudentsiExcursionState();
}

class _StudentsiExcursionState extends State<StudentsiExcursion> {
  ...
  void initState() {
    ...
    _audioPlayer = AudioPlayer()
      ..setAsset('assets/audio/studentsi/studentsi.mp3');
  }
