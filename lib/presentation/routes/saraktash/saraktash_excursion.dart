...
class SaraktashExcursion extends StatefulWidget {
  const SaraktashExcursion({super.key});

  @override
  State<SaraktashExcursion> createState() => _SaraktashExcursionState();
}

class _SaraktashExcursionState extends State<SaraktashExcursion> {
  ...
  void initState() {
    ...
    _audioPlayer = AudioPlayer()
      ..setAsset('assets/audio/saraktash/saraktash_church.mp3');
  }
